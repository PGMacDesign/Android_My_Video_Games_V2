...
public class DetailsActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		details_activity_game_name.setText(pulled_data.get(5));
		details_activity_text_view_release_date.setText("Release Date: " + pulled_data.get(6));
		details_activity_description.setText(pulled_data.get(2));
		details_activity_platform.setText("Platform: " + pulled_data.get(7) + " AKA: " + pulled_data.get(8));
		...
		String played = pulled_data.get(9);
		...
		String rating1 = pulled_data.get(10);
